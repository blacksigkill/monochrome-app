(function() {
  ...
  var TIMEOUT_MS = 6000;
  var SELECTORS = ".sidebar, .player-container, #app, .app";
...
background:#111;color:#eee;display:flex;align-items:center;justify-content:center;height:100vh">\
...
<strong style="color:#ccc">' + EXPECTED_URL + '</strong></p>\
<input id="__src_url_input" type="url" value="' + EXPECTED_URL + '" \
